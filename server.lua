...
RegisterNetEvent('rt-rentals:server:RentVehicle', function(vehicle, plate)
    local src = source
...
RegisterNetEvent('rt-rentals:server:MoneyAmounts', function(vehiclename, price, location)
    local src = source
    ...
    TriggerClientEvent('rt-rentals:client:SpawnVehicle', src, vehiclename, location)
end)
...
CreateThread(function()
	updatePath = "/BayloraiEX/rt-rentals"
	resourceName = "rt-rentals ("..GetCurrentResourceName()..")"
