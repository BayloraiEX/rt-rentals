                    ...
                    options = {
                        {
                            ...
                            label = 'Rent Vehicle',
                            action = function()
                                TriggerEvent('rt-rentals:client:rentVehicle', k)
                            end
...
RegisterNetEvent('rt-rentals:client:rentVehicle', function(k)
        ...
        if location == k then 
            for vehicle, details in pairs(info.vehicles) do 
                table.insert(menu_options, {
                    ...
                    onSelect = function()
                        TriggerServerEvent('rt-rentals:server:MoneyAmounts', vehicle, details.price, location)
                    end
                })
            end
        end
...
RegisterNetEvent('rt-rentals:client:SpawnVehicle', function(vehiclename, location)
    ...
    TriggerServerEvent('rt-rentals:server:RentVehicle', vehiclename, plate)
